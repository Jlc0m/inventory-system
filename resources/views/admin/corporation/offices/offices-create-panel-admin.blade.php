                    ...
                    <div class="card card-info">
                        ...
                        <form class="card-body" action="{{ route('offices.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="office_name" class="form-control" name="name" placeholder="Enter name office">
                            </div>

                            <div class="form-group">
                                <label for="address">Address - </label>
                                <input type="address" class="form-control" name="address" placeholder="Enter address office">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="description" class="form-control" name="description" placeholder="Enter description office"></textarea>
                            </div>
                            <hr>
